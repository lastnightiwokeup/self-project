...
// const DB_DRIVER: string | undefined = process.env.DB_DRIVER;
// const DB_SERVER: string | undefined = process.env.DB_SERVER;
...
// const DB_DB: string | undefined = process.env.DB_DB;
// const APP_URL: string | undefined = process.env.APP_URL;
// /**
